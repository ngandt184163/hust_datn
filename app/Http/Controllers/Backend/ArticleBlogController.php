...
class ArticleBlogController extends Controller
{
    ...
    //     return view('backend.article_blog.index', $viewData);
    // }

    public function create()
    {
        $menus = Menu::all();
        return view('backend.article_blog.create', compact('menus'));
    }
    ...
    public function store(ArticleBlogRequest $request)
    {
        try {
            ...
            return redirect()->route('get_admin.article_blog.create');
        }
    ...
    public function edit($id)
    {
        ...
        return view('backend.article_blog.update', $viewData);
    }
    ...
    public function update(ArticleBlogRequest $request, $id)
    {
        try {
            ...
            return redirect()->route('get_admin.article_blog.update', $id);
        }
