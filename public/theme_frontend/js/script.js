...
jQuery(document).ready(function ($) {
    ...
    //--- side message box
    $(
        ".friendz-list > li, .chat-users > li, .drops-menu > li > a.show-mesg"
    ).on("click", function () {
    ...
    jQuery(".post-comt-box textarea").on("keydown", function (event) {
        if (event.keyCode == 13) {
            ...
            var comment_HTML =
                '<li><div class="comet-avatar"><img alt="" src="images/resources/comet-2.jpg"></div><div class="we-comment"><h5><a title="" href="time-line.html">Sophia</a></h5><p>' +
                comment +
