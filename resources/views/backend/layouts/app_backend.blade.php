...
<head>
    ...
    <title>ADMIN-PETTO - {{ date('Y') }}</title>
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    ...
    <div class="dropdown" style="margin-right: 10px;">
        <button class="btn dropdown-toggle" style="background: none;color: white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img src="{{ pare_url_file(Auth::user()->avatar) }}" onerror="this.src='https://cuocsongdungnghia.com/wp-content/uploads/2018/05/loi-hinh-anh.jpg';" style="width: 40px;height: 40px;border-radius: 50%" alt="">
        </button>
